...
class Cliente:
    ...
    # def get_dias_timeout(self): return self.__dias_timeout
    # def get_timeout_inicio(self): return self.__timeout_inicio
    ...
    def to_json(self):
        return {
            ...
            # "timeout_inicio": self.__timeout_inicio
        }
        ...
        try:
            with open("Biblioteca/models/clientes.json", mode="r") as arquivo:
                ...
                for obj in Clientes_json:
                    aux = Cliente(obj["id"], obj["nome"], obj["email"], obj["matricula"], obj["senha"])
                    #obj["dias_timeout"], datetime.datetime.strptime(obj["timeout_inicio"], "%d/%m/%Y")
